...
require = (function e(t, n, r) {
    ...
    4: [
        function(require, module, exports) {
            ...
            "../less/environment/abstract-file-manager.js": 12,
            "promise": undefined
        }
    ],
    5: [
 ...
 */
    ...
    27: [
        function(require, module, exports) {
            ...
            "./contexts": 8,
            "./data": 10,
            "./environment/abstract-file-manager": 12,
            ...
            "./plugin-manager": 34,
            "./render": 35,
            "./source-map-builder": 36,
            "./source-map-output": 37,
            "./transform-tree": 38,
            "./tree": 56,
            "./utils": 77,
            "./visitors": 80
                ...
                return {
                    ...
                    parsers: parsers = {
                        ...
                        selector: function(isLess) {
                            ...
                            if (elements) {
                                return new(tree.Selector)(elements, extendList, condition, index, fileInfo);
                            }
                            if (extendList) {
        ...
        function(require, module, exports) {
            ...
            Definition.prototype.matchCondition = function(args, context) {
                if (this.condition && !this.condition.eval(
                    new contexts.Eval(context, [this.evalParams(context, new contexts.Eval(context, this.frames ? this.frames.concat(context.frames) : context.frames), args, [])] // the parameter variables
